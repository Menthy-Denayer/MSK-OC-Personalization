...
% general settings
S.misc.forward_velocity = 1.24;
S.subject.base_joints_arms = [];                                            % no arms
S.subject.adapt_IG_pelvis_y = 1;                                            % adapt vertical pelvis position

% Achilles tendon stiffness
S.subject.tendon_stiff_scale = {'gastroc',0.5,'soleus',0.5};                  % done for 2D model

% S.bounds.Qs = {'pelvis_rotation',-7.5,7.5,'lumbar_extension',2,4,'hip_rotation',-5,[]};
