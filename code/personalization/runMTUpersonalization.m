...
pathOutputFolder = uigetdir("C:\Users\menth\Documents\Programmas\PredSimResults","Choose the output directory.");
...
params.FmaxGen = Fmax;
params.includeTendonStiffness = true;
...
tendonStiffnessMin = 0.2;                                                   % min. allowed tendon stiffness
tendonStiffnessMax = 1;                                                     % max. allowed tendon stiffness
...
params.IKweight = 1;
params.PennAnglePenalty = false;
params.PennAngleweight = 100;
params.lMoptPenalty = false;
...
params.adaptedModelPath = "C:\Users\menth\Documents\Programmas\PredSim\Subjects\SUBJ10mtu3D\active\SUBJ10mtu3D.osim";
...
% muscle properties + max muscle force
...
S.misc.subject_path = 'C:\Users\menth\Documents\Programmas\PredSim\Subjects\SUBJ10mtu3D\active';
params.S = S;
